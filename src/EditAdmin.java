...
public class EditAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        columnlist.setBackground(new java.awt.Color(0, 153, 255));
        columnlist.setFont(new java.awt.Font("Segoe UI Semibold", 0, 14)); // NOI18N
        columnlist.setForeground(new java.awt.Color(255, 255, 255));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String query = "UPDATE admininfo SET "+column+" = '"+id+"'";
